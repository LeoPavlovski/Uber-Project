...
<!--Validation here-->
        <div>
          <input type="text" v-maska data-maska="+389########" name="phone" v-model="phone" id="phone" placeholder="1 (234) 567-8910" class="mt-1 block w-full px-3 py-2 rounded-md border border-gray-300 shadow-sm">
        </div>
      </div>
